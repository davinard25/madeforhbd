...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|ANINDIYANA NISA PUTRI|❤',
    ...
    pages: [
        ...
        { 
            ...
            content: 'Happy Birthday Sayang, wish u all the best💗' 
        },
        { 
...
function tryStartWebsiteWhenLandscape() {
    // Nama fungsi dipertahankan agar kode lama tetap kompatibel.
    // Website sekarang dapat berjalan pada portrait maupun landscape.
