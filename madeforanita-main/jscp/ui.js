...
function checkOrientation() {
    // Portrait dan landscape sama-sama didukung.
    // Website tidak lagi memaksa pengguna memutar HP.
    ...
    // Sesuaikan canvas ketika ukuran/orientasi layar berubah.
    setTimeout(() => {
        forceResizeMatrix();
...
S = {
    initialized: false,
    init: function () {
        // Portrait dan landscape sama-sama diperbolehkan.
